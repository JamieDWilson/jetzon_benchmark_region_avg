...
% simplified linear version of Weber et al., (2016)
% with Northern and Southern Hemisphere Splits
...
ET=ET_A | ET_P; % join Atlantic and Pacific because can't do in one line
ST=lat>-40 & lat<40; ST(ET)=false; %  define ST and remove ET data

regions.ET_N = ET & lat>0;
regions.ET_S = ET & lat<0;

regions.ST_N = ST & lat>0;
regions.ST_S = ST & lat<0;
