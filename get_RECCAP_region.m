...
if ~isempty(varargin)
    ...
    % hard-code JETZON benchmark regions in for ease
    if strcmp(varargin{1},'jetzon')
        varargin={'Arctic',[17:26],...
            'North Atlantic',[1:2],...
            'North Pacific',[7:8],...
            'Subtropical North Atlantic',[3]...
            'Subtropical North Pacific',[9],...
            'North Indian',[13 14],...
            'Equatorial Atlantic',[4],...
            'Equatorial Pacific',[11],...
            'Subtropical South Atlantic',[5],...
            'Subtropical South Pacific',[10 12],...
            'South Indian',[15 16],...
            'Subantarctic',[27],...
            'Antarctic',[28 29]};
    end
